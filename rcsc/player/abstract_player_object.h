...
public:
    ...
    */
    ...
    int cycles_to_cut_ball_with_safe_thr_dist(const WorldModel & wm, const Vector2D & ball_pos,
            ...
            reach_cycle_kick = cycles_to_cut_ball_direct_kick(wm,
                                                              ball_pos,
                                                              max_cycle,
                                                              ...
                                                              safe_dist_thr);
            if (check_tackle)
                reach_cycle_tackle = cycles_to_cut_ball_direct_tackle(wm,
                                                                      ball_pos,
                                                                      max_cycle,
            ...
            if (max_cycle <= 5 && check_omni)
                reach_cycle_omni = cycles_to_cut_ball_omni_kick(wm,
                                                                ball_pos,
                                                                max_cycle,
